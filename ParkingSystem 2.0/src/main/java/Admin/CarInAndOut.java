...
public class CarInAndOut extends javax.swing.JFrame {
    ...
    public static Queue<Vehicle> outQ;
    
    /**
     * Creates new form CarInAndOut
     * @param p
     */
    public CarInAndOut(Parking p, Queue inQ, Queue outQ) {
        try {
            if (this.p == null) {
                this.p = p;
                CarInAndOut.inQ = inQ;
                CarInAndOut.outQ = outQ;
            }
    ...
    private void initComponents() {
        ...
        txtInQueueSize = new javax.swing.JTextField();
        ...
        txtOutQueueSize = new javax.swing.JTextField();
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(95, 95, 95)
                .addComponent(btnGoIn, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        txtInQueueSize.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtInQueueSizeActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtInQueueSize, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel12)
                    .addComponent(txtInQueueSize, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        txtOutQueueSize.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtOutQueueSizeActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtOutQueueSize, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel15)
                    .addComponent(txtOutQueueSize, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(7, 7, 7)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel16)
    ...
    private void btnDemoCarInx1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDemoCarInx1ActionPerformed
        ...
        try {
            ...
            inQ.add(carIn);
            txtInQueueSize.setText(String.valueOf(inQ.size()));
...
//            }
            ...
            if(p.currentVehicleInParkingLot.isEmpty()){
                ...
                int random = (int) ((Math.random() * ((p.currentVehicleInParkingLot.size()-1) - 0)) + 0);
                ...
                for (int i = 1; i < p.getMaxRow() + 1; i++) {
                    for (int j = 1; j < p.getMaxColumn() + 1; j++) {                   
                        ...
                        else if (p.getSlot(i, j).getVehicle().getTicket().getID() == out.getTicket().getID()) {
    ...
    private void txtInQueueSizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtInQueueSizeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtInQueueSizeActionPerformed

    private void txtOutQueueSizeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtOutQueueSizeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtOutQueueSizeActionPerformed
